    ...
    override fun onBindViewHolder(holder: ForeCastHolder, position: Int) {
        ...
        for (i in forecastObject.weather) {
            ...
            if (i.icon == "01d") {
                ...
                holder.imageGraphic.setImageResource(R.drawable.d1)
                holder.smallIcon.setImageResource(R.drawable.d1)
            }

            if (i.icon == "01n") {
                holder.imageGraphic.setImageResource(R.drawable.n1)
                holder.smallIcon.setImageResource(R.drawable.n1)
